  ...
  Widget build(BuildContext context) {
            ...
            child: Column(
              children: [
                ...
                AspectRatio(
                  aspectRatio: 1 / 1,
                  child: Image.network(
                    //图片刚加载的时候数据为空会闪个错误信息,所以需要再开始先判断数据有没有值,有值再渲染
                    HttpsClient.replaeUri(controller.pcontent.value.pic),
                    fit: BoxFit.cover,
                  ),
                ),
                //标题
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                  color: Colors.red,
                                  fontSize: ScreenAdapter.width(86)),
                            )
                          ],
                        ),
                        Row(
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                  ...
                                  fontSize: ScreenAdapter.width(46),
                ...
                Container(
                  ...
                  padding: EdgeInsets.only(top: ScreenAdapter.height(20)),
                  child: InkWell(//InkWell比手势事件触发的范围大
                    //手势事件
                    onTap: () {
                      //如何调用父组件方法,从子组件里传过来
                      showBottomAttr(1);
    ...
    '''),
        ...
        : SizedBox(
            ...
            child: const Center(
              child: CircularProgressIndicator(), //加载一个圈圈
            ),
          ));
  }
}
